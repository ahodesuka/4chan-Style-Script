...
(function()
{
    var defaultConfig =
    {
        ...
        [
            ...
            { img: "http://i.imgur.com/xwPrX.png", color: "9e71a5", enabled: true                                                          }  // yozora
        ],
        "Nav Links":
        [
        ...
        options:
        {
            ...
            showMascot: function(mIndex) // TODO: Fix base64 input element- why cant chrome & opera hold all these chars- why is firefox and opera so slow
            {
                ...
                div = $("<div id=addMascot>").html("<label><span title='URL or base64'>Background:</span><textarea name=customIMG>" + (bEdit ? mEdit.img : "") + "</textarea></label>\
                        <label title='i.e. #FF6999'><span>Color (Hex.):</span><input type=text name=customColor value='#" + (bEdit ? mEdit.color : "") + "'></label>\
