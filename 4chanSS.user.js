            ...
            show: function()
            {
                ...
                else
                {
                    ...
                    for (key in config)
                    {
                        ...
                        else if (key != "Fonts" && key != "Themes" && key != "Theme Inputs") // make Themes tab, and font add/remove div
