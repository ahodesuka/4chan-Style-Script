        ...
        jscolor:
        {
            ...
            color: function(target)
            {
                ...
                function drawPicker(x, y)
				{
                    ...
                    p.padM.onmouseup =
                    p.padM.onmouseout = function() { if (holdPad) { holdPad=false; $SS.jscolor.fireEvent(valueElement,"change"); } };
                    ...
                    p.sldM.onmouseup =
                    p.sldM.onmouseout = function() { if (holdSld) { holdSld=false; $SS.jscolor.fireEvent(valueElement,"change"); } };
                ...
                var THIS = this;
                var abortBlur = false;
                var valueElement = $SS.jscolor.fetchElement(this.valueElement),
