...
(function()
{
    var defaultConfig =
    {
        ...
        "Mascots":
        [
            { img: "http://i.imgur.com/DL5uR.png", enabled: true                                      }, // asuka
            ...
            { img: "http://i.imgur.com/MdE9K.png", enabled: true, flip: false, small: true            }, // mio
            { img: "http://i.imgur.com/NaKmF.png", offset: 0, enabled: true                           }, // mokou
            { img: "http://i.imgur.com/K1mLx.png", enabled: true, flip: false                         }, // shana
    ...
    $SS =
    {
        ...
        options:
        {
            ...
            addMascot: function(mIndex)
            {
                ...
                {
                    var m = { img: cIMG, enabled: true, small: cSmall, flip: cFlip };
                    tIMG = new $SS.Image(cIMG);
        ...
        Mascot: function(mascot)
        {
            ...
            this.offset   = this.bOffset ? mascot.offset : (config["Post Form"] != 1 ? 275 : 23);
        },
