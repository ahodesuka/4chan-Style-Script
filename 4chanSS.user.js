...
(function(){
    ...
    $SS =
    {
        ...
        Color: function(hex)
        {
            ...
            this.shiftRGB = function(shift)
            {
                var rgb = [];
                rgb = this.rgb.split(",");
                
                rgb[0] = Math.min(Math.max(parseInt(rgb[0]) + shift, 0), 255);
                rgb[1] = Math.min(Math.max(parseInt(rgb[1]) + shift, 0), 255);
                rgb[2] = Math.min(Math.max(parseInt(rgb[2]) + shift, 0), 255);
        ...
        Theme: function(theme, mascotColor)
        {
            ...
            this.linkColor  = new $SS.Color(theme.oLinkColor ? theme.linkColor : mascotColor);
    ...
    *:-moz-placeholder{color:#999!important}\
    ...
    hr{border:0!important;border-top:1px solid rgba(" + theme.mainColor.rgb + ",.9)!important;margin:1px 0 1px -1px!important;padding-right:1px!important}\
    ...
    a{text-decoration:none!important;color:" + theme.linkColor.hex + "!important;font-weight:normal!important;-webkit-transition:all .1s ease-in-out;-moz-transition:all .1s ease-in-out;-o-transition:all .1s ease-in-out}\
    a:hover{color:" + theme.linkHColor.hex + "!important;text-shadow:rgba(" + theme.linkHColor.rgb + ",.2) 0 0 2px!important}\
    a:not([href]),a[href='javascript:;']{color:" + theme.jlinkColor + "!important}\
    ...
    .pages,#imgControls #imageType,.deletebuttons,.deletebuttons::before,\
    .postarea,#qr,#post,a.omittedposts:hover{background:rgba(" + theme.mainColor.rgb + ",.9)!important}\
    body>center:nth-of-type(2)>font[color=red],#header{background:" + theme.mainColor.hex + "!important}\
    ...
    body,.reply,.replyhl,input,select,.omittedposts,a.omittedposts,a.omittedposts:hover,blockquote>.abbr,.deletebuttons::before,.replymode,tr,div,\
    textarea,div.autohide>a,#themeoptions #toNav li label.selected,#themeoptions #toNav li label:hover,#imgControls>label::before,#qr .move::before,\
    #stats span,body>center:nth-of-type(2)>font[color=red]::after,.pages b,#navtopr span,.pages td{color:" + theme.textColor.hex + "!important}\
    body,.pages,#imgControls>label{border-right:1px solid " + theme.brderColor.hex + "!important}\
    body{background:" + theme.bgImg.get() + theme.bgColor +"!important;margin:0 315px 0 0!important;padding:0!important}\
    body::before{border-left:1px solid " + theme.brderColor.hex + ";content:'';height:100%;width:312px;position:fixed;right:0;z-index:-1}\
    body::after{background:" + mascot.img.get() + " rgba(" + theme.mainColor.shiftRGB(-18) + ",.8);content:'';height:100%;width:313px;\
    border-left:2px solid rgba(" + theme.mainColor.rgb + ",.9);position:fixed;right:0;bottom:18px;z-index:-2}\
    #themeoptions #toWrapper,#options ul,#updater:hover,.logo img,#jsmath_button,#jsMath_panel,#jsMath_float{border:1px solid " + theme.brderColor.hex + "!important}\
    .deletebuttons,.postarea,body>span[style]~#qr,#thread_filter>div:first-child>span.autohide,#header,.pages{border-top:1px solid " + theme.brderColor.hex + "!important}\
    ...
    textarea,input:not([type=submit]),select,#updater span,#navtopr span{font:" + config["Font Size"] + "px " + config["Font"] + ",Calibri,Helvetica,sans-serif!important}\
    div.thread{background:rgba(" + theme.mainColor.rgb + ",.3);margin:0 0 1px;padding:3px 0 0!important;position:relative;border-radius:3px 0 0 3px}\
    ...
    div.op{border:0!important;position:relative}\
    div.op>a:first-child:not([name]):not(.reportbutton){position:absolute;right:2px;top:0}\
    form[name=delform]{border-left:2px solid rgba(" + theme.mainColor.rgb + ",.9);border-bottom:2px solid rgba(" + theme.mainColor.rgb + ",.9);margin:0 0 42px 30px;\
    padding:" + (config["Show Announcements"] ? "19px" : "0") + " 0 0 1px;position:relative;border-radius:0 0 0 6px}\
    ...
    " + (theme.replyBrder ? ".reply,.replyhl,.stub{border:1px solid " + theme.brderColor.hex + "!important;border-right:0!important}" : "") + "\
    .reply,.replyhl{display:inline-block;position:relative!important}\
    .replyhider{margin:0!important;padding:1px 0 0!important;position:absolute;right:2px;width:auto!important;z-index:1}\
    td.reply,td.replyhl{-webkit-transition:all .1s ease-in-out;-moz-transition:all .1s ease-in-out;-o-transition:all .1s ease-in-out;}\
    td.reply,td.replyhl,div.stub{padding:5px!important;width:100%;border-radius:3px 0 0 3px;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box}\
    td.replyhl,td.qphl{background:rgba(" + theme.linkColor.rgb + ",.2)!important;box-shadow:inset rgba(150,150,150,.1) 0 0 3px}\
    ...
    .container::before{color:rgba(" + theme.textColor.rgb + ",.6);content:'REPLIES:';padding-right:3px}\
    .qphl{outline:none!important}\
    #qp{background:rgba(" + theme.mainColor.shiftRGB(-4) + ",.98)!important;border:1px solid rgba(" + theme.linkColor.rgb + ",.4)!important;margin:0 10px!important;max-width:65%;padding:5px;position:fixed!important;z-index:11!important;box-shadow:rgba(0,0,0,.3) 0 2px 5px;border-radius:3px}\
    ...
    a.omittedposts{background:rgba(" + theme.mainColor.shiftRGB(-4) + ",.9);margin:0 10px!important;padding:2px 6px;border-radius:3px 3px 0 0}\
    .deletebuttons{border-left:1px solid " + theme.brderColor.hex + "!important;position:fixed;bottom:18px;right:315px;\
    ...
    .deletebuttons::before{content:'X';display:inline-block;position:absolute;left:0;top:0;width:20px;height:24px;text-align:center;padding-top:1px;line-height:20px}\
    ...
    .deletebuttons input[type=password]{margin-left:4px!important}\
    .deletebuttons:hover input[type=password]{margin-left:0!important}\
    " + (config["Replace Reply Form"] ? "body>span[style]~.postarea,body>span[style]~#qr #close," : "") +  (!config["Show Logo"] ? ".logo," : "") +
    "#recaptcha_logo,#recaptcha_tagline,td[align=right],td.rules,img + br,iframe,#BF_WIDGET,.bf,\
    ...
    body>span[style]~#navlinks,#navtop,#navtopr,#qr #autohide{display:none!important}\
    table,td{border:0!important;color:#ccc!important}\
    .replymode{background-color:transparent!important}\
    ...
    #recaptcha_table #recaptcha_image{background-color:transparent!important;margin-left:0!important;border:0!important}\
    ...
    div.reply{border:0!important;margin:0!important;z-index:2!important}\
    ...
    {background:rgba(22,22,22,0.9)!important;border:0!important;border-right:1px solid #262626!important;font-size:8px!important;text-transform:uppercase!important;\
    ...
    input,select{-webkit-transition:all .1s ease-in-out;-moz-transition:all .1s ease-in-out;-o-transition:all .1s ease-in-out}\
    ...
    input[name=recaptcha_response_field],input#recaptcha_response_field{border:0!important;height:22px!important;padding:1px 4px!important;width:305px!important;border-bottom:1px solid #101010!important;border-top:1px solid #262626!important}\
    ...
    .logo img{margin:0!important;opacity:0.4}\
    ...
    div.autohide>a[title='Auto-hide dialog box']{text-decoration:underline!important}/* What is this for? 4chfilter? */\
    #captchas{padding:0 3px}\
    ...
    #watcher .move,#updater .move,#options .move,#stats .move,#filter>div:first-child,#thread_filter>div:first-child{cursor:default!important}\
    ...
    #themeoptions #toWrapper{background:rgba(0,0,0,.3);height:300px;box-shadow:inset rgba(0,0,0,.3) 0 0 5px, rgba(150,150,150,.3) 0 1px 3px;border-radius:5px}\
    ...
    #themeoptions #tMascot div.selected{background:rgba(" + theme.linkColor.rgb + ",.6);box-shadow:inset rgba(0,0,0,.15) 0 0 15px, rgba(" + theme.linkColor.rgb + ",.6) 0 0 2px}\
    ...
    #themeoptions textarea{background:transparent!important;border:0!important;height:100%!important;width:100%!important;resize:none}\
    ...
    #options ul{padding:2px 5px!important;border-radius:5px;box-shadow:inset #444 0 0 5px}\
    ...
    body>span[style]~#thread_filter>div:first-child>span.autohide{border:0!important}\
    ...
    #imgControls #imageType{border:0!important;float:left;font-size:12px!important;max-height:16px!important;max-width:85px;line-height:14px!important}\
    #imgControls>label{float:right;height:18px!important}\
    #imgControls>label::before{content:'EXPAND';font-size:9px!important}\
    ...
    form[name=post] input[name=email]+label,#watcher .move,#themeoptions .move,#updater span,body>a[style='cursor: pointer; float: right;']\
    ...
    .postarea,body>span[style]~#qr{right:0;bottom:-312px;top:auto!important;left:auto!important;padding:3px;\
    -webkit-transition:bottom .2s ease-in-out 1s;-moz-transition:bottom .2s ease-in-out 1s;-o-transition:bottom .2s ease-in-out 1s}\
    .postarea,#qr{width:306px!important;height:347px;position:fixed!important;z-index:1!important;margin:0!important}\
    .postarea:hover,body>span[style]~#qr:hover{-webkit-transition:bottom .2s ease-in-out;-moz-transition:bottom .2s ease-in-out;-o-transition:bottom .2s ease-in-out}\
    .postarea:hover{bottom:7px}\
    ...
    #qr{border:1px solid " + theme.brderColor.hex + "!important;height:auto!important;width:312px!important;z-index:9!important}\
    #qr .move{cursor:move!important;padding:3px!important}\
    body>span[style]~#qr{border:0!important;border-top:1px solid " + theme.brderColor.hex + "!important;bottom:-301px!important;height:auto!important;width:306px!important;z-index:1!important}\
    body>span[style]~#qr:hover{bottom:18px!important}\
    body>span[style]~#qr .move{cursor:default!important;padding:0!important}\
    body>span[style]~#qr .autohide{padding:0!important}\
    #qr .autohide{height:auto!important;overflow:visible!important;padding:3px!important}\
    #qr:hover .autohide{height:auto!important;overflow:visible!important}\
    ...
    #qr input[name=upfile]+a,#qr #captchas,#qr #attach,#qr #close{line-height:22px;position:absolute;right:6px;top:1px}\
    ...
    #qr .move::before{content:'QUICK REPLY'}\
    ...
    #updater:hover{border-top:none!important;border-right:none!important;right:0!important;padding-bottom:3px;width:166px!important}\
    ...
    #stats span{font-size:9px!important;margin:0 2px}\
    ...
    body>center:nth-of-type(2)>font[color=red]:hover{top:0!important}\
    body>center:nth-of-type(2)>font[color=red]::after{content:'ANNOUNCEMENT';display:block;line-height:18px;font-size:10px!important}\
    body>center:nth-of-type(2)>font[color=red]>b{display:block;overflow:auto;width:100%;padding:5px}\
    #header{left:0!important;height:18px!important;width:100%!important;padding:0!important;position:fixed!important;\
    top:auto!important;bottom:0!important;z-index:9!important;text-align:center;line-height:18px}\
    #navtop,#navtopr{float:none!important}\
    #navtop a{text-shadow:rgba(0,0,0,.3) 0 0 3px}\
    #navtopr{position:absolute;right:5px!important;top:0;font-size:0!important;color:transparent!important}\
    .pages{margin:0!important;padding-top:1px;width:auto!important;height:24px;\
    ...
    .pages b{font-weight:700!important}\
    .pages a:not(:last-child),.pages b:not(:last-child){margin:0 2px}\
    .pages input{background:rgba(33,33,33,.9)!important;border:0!important;height:22px!important;width:auto!important;padding:0 10px!important;position:relative;top:-1px}\
    ...
    function DOMLoaded()
    {
        ...
        setTimeout(function()
        {
            ...
            if ((qr = $("#qr")).exists())
            {
                var setQRPos = function()
                {
                    var q = $("#qr");
                    $("#qr").attr("style", "bottom:" + -(q.get().scrollHeight - 41) + "px!important");
                };
                
                qr.bind("mouseover", function(){ $(this).attr("style", ""); })
                  .bind("mouseout", setQRPos);
            }
        }, 30);
    }
