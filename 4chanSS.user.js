...
(function()
{
    var defaultConfig =
    {
        ...
        "Sidebar Size":
        [
            315, "Change the size of the sidebar",
            [
                { name: "Original", value: 315 },
        ...
        [
            ...
            { img: "http://i.imgur.com/I3zIl.png",                            color: "c63839", enabled: true },
            ...
            setTimeout(function()
            {
                if (!reload)
                {
                    ...
                    if ((prev = $(".pages td input[value='Previous']")).exists())
                        ...
                        prev.text("").attr("style", "padding:0!important");
                }
        ...
        options:
        {
            ...
            addMascot: function(mIndex)
            {
                ...
                if (typeof mIndex === "number")
                {
                    ...
                    $("#mascot" + mIndex).children("img").attr("src", nMascot.img.get(true));
                }
                else
                {
                    nMascot = new $SS.Mascot(cIMG, cColor, true);
