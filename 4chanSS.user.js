            ...
            color: function(target) {
                ...
                this.showPicker = function() {
                    if(!isPickerOwner()) {
                        ...
                        var vp = $SS.jscolor.getViewPos(); // view pos
                        var vs = $SS.jscolor.getViewSize(); // view size
                ...
                function drawPicker(x, y) {
                    if(!$SS.jscolor.picker) {
                        ...
                        $SS.jscolor.picker.btnS.appendChild($SS.jscolor.picker.btnT);
                        $SS.jscolor.picker.btn.appendChild($SS.jscolor.picker.btnS);
                        $SS.jscolor.picker.box.appendChild($SS.jscolor.picker.btn);
                ...
                function getPickerDims(o) {
                    var dims = [
                        ...
                        o.pickerClosable ?
                            4*o.pickerInset + 3*o.pickerFace + $SS.jscolor.images.pad[1] + o.pickerButtonHeight :
                ...
                // target
                $(target).bind('focus', function(){ if(THIS.pickerOnfocus) THIS.showPicker(); })
                .bind('blur', function()
                {
                    if(!abortBlur)
