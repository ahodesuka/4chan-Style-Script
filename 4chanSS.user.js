    ...
    $SS =
    {
        ...
        options:
        {
            ...
            getMascot: function()
            {
                ...
                return new $SS.Mascot(m.img, m.color, enabled);
            },
        ...
        Theme: function(theme)
        {
            ...
            this.linkColor   = new $SS.Color(theme.oLinkColor || !mascot.enabled ? theme.linkColor : mascot.color.substr(1));
