...
(function()
{
    ...
    SSf.prototype = 
    {
        ...
        riceCheck: function()
        {
            return this.each(function()
            {
                if ($(this).attr("riced") === "true") return;
    ...
    $SS =
    {
        ...
        Mascot: function(mascot)
        {
            ...
            this.offset   = typeof mascot.offset === "number" ? mascot.offset : (config["Post Form"] != 1 ? 275 : 22);
        },
