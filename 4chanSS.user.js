...
(function()
{
    ...
    RbotDOTexe    = "";
                ...
                else
                {
                    ...
                    for (key in config)
                    {
                        ...
                        if (Array.isArray(defaultConfig[key][2]))
                        {
                            ...
                            {
                                optionsHTML += "</select>\
                                <div hidden><object id=fontListSWF type='application/x-shockwave-flash' data='data:application/x-shockwave-flash;base64," + RbotDOTexe + "' width=1 height=1></object></div>\
                                </label>";
                            }
                            else
                        ...
                        else if (key != "Themes" && key != "Theme Inputs") // make Themes tab, and font add/remove div
