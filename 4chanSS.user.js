...
(function()
{
    ...
    defaultIcons  = "",
    ...
    SSf.prototype = 
    {
            ...
            return this.each(function()
            {
                $(this).bind("change", function()
                {
                    ...
                    for (var i = 0, MAX = this.files.length; i < MAX; i++)
                        files[i] = this.files[i].name.substr(this.files[i].name.lastIndexOf("\\") + 1);
                        
                    $(this).nextSibling("span").text(files.join(","));
                });
            });
        },
        riceCheck: function()
        {
            return this.each(function()
            {
                if ($(this).attr("riced"))
                {
                    $(this).nextSibling(".riceCheck").bind("click", function(e)
                    {
                        e.preventDefault();
                ...
                {
                    e.preventDefault();
                    $(this).previousSibling("input[type=checkbox][riced]").val(!$(this).previousSibling("input[type=checkbox][riced]").val());
                });
    ...
    $SS =
    {
        ...
        DOMLoaded: function(reload)
        {
            ...
            setTimeout(function()
            {
                if (!reload)
                {
                    ...
                    if ((next = $(".pages td:last-child")).exists() && !$(".pages td input[value='Next']").exists())
        ...
        options:
        {
                    ...
                    for (key in config)
                    {
                        ...
                        if (Array.isArray(defaultConfig[key][2]))
                        {
                            ...
                            if (key == "Font" && cFonts.indexOf(config["Font"]) == -1)
                               optionsHTML += "<option style='font-family:\"" + config["Font"] + "\"!important' value='" + config["Font"] + "' selected>" + config["Font"] + "</option>"; 
            ...
            loadSystemFonts: function(evt)
            {
                ...
                window.addEventListener("message", getFontMessage = function(e)
                {
                    ...
                    for (var i = 0, MAX = fontList.length; i < MAX; i++)
                    {
                        ...
                        fontSelect.append($("<option" + " style='font-family:\"" + value + "\"!important'" + " value='" + value + "'" + (value == config["Font"] ? " selected=true" : "") + ">" + name));
                    }
            ...
            showMascot: function(mIndex) // TODO: Fix base64 input element- why cant chrome & opera hold all these chars- why is firefox and opera so slow
            {
                var div, overly;
                ...
                div = $("<div id=addMascot>").html("<label><span>Image:</span><input type=text name=customIMG value='" + (bEdit ? ($SS.validImageURL(mEdit.img) ? mEdit.img : "[Base 64 Encoded Image]' disabled") : "'") + "></label>\
                        ...
                        <div>\
                        <div id=selectImage><input type=file riced=true>\
                        <span class=trbtn accept='image/GIF,image/JPEG,image/PNG'>Select Image</span></div>\
        ...
        Mascot: function(mascot)
        {
            ...
            this.offset   = typeof mascot.offset === "number" ? mascot.offset : (config["Post Form"] != 1 ? 302 : 22);
        },
        ...
        buildCustomNav: function()
        {
            ...
            $("#navtop").append($("<div>").html(a.join(config["Nav Link Delimiter"])));
        }
    };
