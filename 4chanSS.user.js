...
(function()
{
    var defaultConfig =
    {
        ...
        "Sidebar Size":
        [
            317, "Change the size of the sidebar",
            [
    ...
    }, SSf, $SS, config, theme, mascot, css,
    MAX_FONT_SIZE = 16,
    MIN_FONT_SIZE = 10,
    NAMESPACE     = "4chanSS.",
                ...
                if ((pages = $(".pages")).exists())
                {
                    ...
                    if (config["Pages Position"] == 1)
                    {
                        ...
                        if (pages.exists())
                        {
                            ...
                            {
                                pages.attr("style",
                                    (config["Sidebar Position"] == 1 ? "left" : "right") + ":" +
