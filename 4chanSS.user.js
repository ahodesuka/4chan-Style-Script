        ...
        DOMLoaded: function(reload)
        {
            ...
            if (config["Pages Location"] == 1)
            {
                ...
                if (pages.exists())
                {
                    ...
                    {
                        var leftOffset = $(".pages td:last-child").get().offsetWidth - pages.get().offsetWidth;
                        postLoadCSS += ".pages{left:" + leftOffset + "px!important}";
                    };
                    
                    if (reload === true)
                        setTimeout(adjustPages, 1);
                    else
                        adjustPages();
                }
            }
            ...
            if (reload === true)
                setTimeout(function(){ $("#ch4SS").appendText(postLoadCSS); }, 1);
            else
            {
                ...
                setTimeout(function()
                {
                    ...
                    if ((qr = $("#qr")).exists())
                    {
                        ...
                        if (!autohide.val())
                            ...
                            autohide.parent().attr("style", "bottom:" + -(autohide.parent().get().offsetHeight - 42) + "px!important");
                        
                        // Fix for slide up QR
                        qr.bind("mouseover", function(){ if (autohide.val()) $(this).attr("style", ""); })
                          .bind("mouseout", function(){ if (autohide.val()) $(this).attr("style", "bottom:" + -(this.offsetHeight - 42) + "px!important"); });
                    }
        ...
        options:
        {
            ...
            show: function()
            {
                ...
                else
                {
                    ...
                    $(document).bind("keyup", $SS.options.keyup);
            ...
            save: function()
            {
                ...
                $(document).unbind("keyup", $SS.options.keydown);
