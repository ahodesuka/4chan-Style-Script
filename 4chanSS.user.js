    ...
    $SS =
    {
        ...
        DOMLoaded: function(reload)
        {
            ...
            if (!reload)
            {
                ...
                div = $("#boardNavDesktop").prepend(select.bind("change", function()
                {
