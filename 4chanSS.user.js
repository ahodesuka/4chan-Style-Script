        ...
        DOMLoaded: function(reload)
        {
            ...
            setTimeout(function()
            {
                if (!reload)
                {
                    ...
                    if ($SS.bNewQR && !$("#qr").exists()) // force persistent QR with 2.25+
                    {
