    ...
    $SS =
    {
        ...
        setCSS: function()
        {
            ...
            if (config["Pages Location"] == 2)
                css += ".pages{background:transparent!important;height:18px!important;margin:0!important;border:0!important;bottom:0!important;left:0!important;z-index:9!important}\
        ...
        DOMLoaded: function(reload)
        {
            ...
            if (config["Show Announcements"] && ann.exists())
                postLoadCSS += "body>center:nth-of-type(2)>font[color=red]{top:" + (-ann.get().scrollHeight + 18) + "px!important}";
            else
            ...
            setTimeout(function()
            {
                ...
                if ((qr = $("#qr")).exists())
                {
                    ...
                    // Prevent CSS transition when autohide unchecked
                    autohide.bind("change", function(){ if (!autohide.val()) autohide.parent().attr("style", "bottom:18px!important"); });
                    
                    // fix on load
                    if (!autohide.val())
                        autohide.parent().attr("style", "bottom:18px!important");
                    else
                        autohide.parent().attr("style", "bottom:" + -(autohide.parent().get().scrollHeight - 41) + "px!important");
                    
                    // Fix for slide up QR
                    qr.bind("mouseover", function(){ if (autohide.val()) $(this).attr("style", ""); })
                      .bind("mouseout", function(){ if (autohide.val()) $(this).attr("style", "bottom:" + -(this.scrollHeight - 41) + "px!important"); });
                }
        ...
        Color: function(hex)
        {
            ...
            this.shiftRGB = function(shift, smart)
            {
                ...
                shift = smart ?
                    (rgb[0] + rgb[1] + rgb[2] > 400 ? (shift < 0 ? shift : -shift) : Math.abs(shift)) : shift;
        ...
        Theme: function(theme, mascotColor)
        {
            ...
            this.checkMark  = new $SS.Image(theme.scheme == "dark" ? checkMarkLight : checkMarkDark, "no-repeat center center");
            this.mainColor  = new $SS.Color(theme.mainColor);
            this.brderColor = new $SS.Color(theme.brderColor);
            this.inputColor = new $SS.Color(theme.inputColor);
