...
(function()
{
    var defaultConfig =
    {
        ...
        "Mascots":
        [
            { img: "http://i.imgur.com/DL5uR.png", color: "dd3732", enabled: true },
            { img: "http://i.imgur.com/zhPlM.png", color: "6cb2ee", enabled: true },
            { img: "http://i.imgur.com/b9KmB.png", color: "886999", enabled: true },
            { img: "http://i.imgur.com/bsLY4.png", color: "c63839", position: "center", offset: 0,   enabled: true },
            { img: "http://i.imgur.com/Ht6dr.png", color: "b55796", position: "center", offset: -90, enabled: true, small: true },
            { img: "http://i.imgur.com/J1i26.png", color: "ef4353", position: "center", offset: -90, enabled: true },
            { img: "http://i.imgur.com/NaKmF.png", color: "ef4353", position: "center", offset: 0,   enabled: true },
            { img: "http://i.imgur.com/K1mLx.png", color: "ef4353", enabled: true, flip: false },
            ...
            { img: "http://i.imgur.com/xwPrX.png", color: "9e71a5", enabled: true }
        ],
        "Nav Links":
        [
    ...
    MIN_FONT_SIZE = 10,
    NAMESPACE     = "4chanSS.",
    inputImages   = "";
    ...
    $SS =
    {
            ...
            setTimeout(function()
            {
                ...
                else
                {
                    ...
                    if ((qr = $("body>span[style]~#qr")).exists())
                    {
                        ...
                        qr.children("#autohide").bind("change", $SS.fixQRhide);
        ...
        nodeInsertedHandler: function(e)
        {
            ...
            else if (e.target.nodeName == "TABLE") // new replies
            {
